...
import { contentBox, heading2box, heading3box, paragraph } from "../services/styles";
    ...
    return (
        ...
        >
            ...
            <div className={`${contentBox}`}>
                ...
                <h3 className={`${heading3box}`}>Leben heißt Wachstum</h3>

                <p className={`${paragraph}`}>
                    ... im steten Wandel aus Licht und Dunkelheit, Aktivität und Ruhe,
                ...
                <p className={`${paragraph} mt-4`}>
                    ...
                    Über Berührung finden wir eine universelle Sprache der Begegnung - ursprünglich und konkret.
                ...
                <h3 className={`${heading3box}`}>Meine Zen-Shiatsu-Ausbildung</h3>

                <p className={`${paragraph} mt-4`}>
                    ... in der Tradition von Shizuto Masunaga habe ich am Europäischen
                    Shiatsu Institut Berlin abgeschlossen.
                </p>

                <h3 className={`${heading3box}`}>Das Europäische Shiatsu Institut (ESI)</h3>

                <p className={`${paragraph} mt-4`}>
                    ... ist eine der führenden Shiatsuschulen in Deutschland, 
                ...
                <div className="p-3 md:-ml-6 md:-mr-6 mt-5">
                    <img
