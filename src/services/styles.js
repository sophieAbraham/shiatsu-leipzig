...
export const navIcons = 'z-30 fixed top-6 right-5 cursor-pointer text-4xl text-olivedunkel md:hidden'
export const navList = 'bg-gray-300 md:bg-transparent opacity-80 md:opacity-100 backdrop-blur-lg md:backdrop-blur-none pr-28 z-20 fixed top-0 md:top-8 md:right-28 md:h-auto h-screen duration-500 ease-linear'
